...
void details(Airport_Details  d) {
    d.name = "Karachi International Airport";
    d.history = "Karachi International Airport, formerly known as Solara International Airport, was inaugurated on September 15, 1990. The airport was conceptualized as a modern transportation hub to cater to the growing demands of air travel in the region.";
    d.location = "Karachi International Airport is located in Karachi, Pakistan.";
